	...
	SubShader {
		...
		Pass { 
			...
			fixed4 frag(v2f i) : SV_Target {
				...
				fixed3 Splat_color1 = tex2D(_Splat1, i.uv.xy * _Splat0_ST);
				fixed3 Splat_color2 = tex2D(_Splat2, i.uv.xy * _Splat0_ST);
				fixed3 Splat_color3 = tex2D(_Splat3, i.uv.xy * _Splat0_ST);
				fixed3 Splat_color4 = tex2D(_Splat4, i.uv.xy * _Splat0_ST);
				fixed3 Splat_color5 = tex2D(_Splat5, i.uv.xy * _Splat0_ST);
				fixed3 Splat_color6 = tex2D(_Splat6, i.uv.xy * _Splat0_ST);
				fixed3 Splat_color7 = tex2D(_Splat7, i.uv.xy * _Splat0_ST);
				fixed3 Splat_color8 = tex2D(_Splat8, i.uv.xy * _Splat0_ST);
